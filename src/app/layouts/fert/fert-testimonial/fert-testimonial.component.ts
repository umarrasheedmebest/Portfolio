...
@Component({
  selector: 'app-fert-testimonial',
  templateUrl: './fert-testimonial.component.html',
  styleUrls: ['./fert-testimonial.component.scss']
})
export class FertTestimonialComponent implements OnInit {
